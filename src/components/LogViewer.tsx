...
function LogViewer({ provider, title, defaultMaxLines = 100, fullHeight = false }: LogViewerProps) {
  ...
  if (fullHeight) {
    return (
      <div className="h-full flex flex-col">
        ...
        {!error && (
          <>
            <div className="bg-black flex-1 overflow-y-auto p-2">
              {logs.length === 0 ? (
            ...
            {logs.length > 0 && (
              <div className="text-xs text-base-content/70 px-2 py-1 bg-base-100 border-t border-base-300">
