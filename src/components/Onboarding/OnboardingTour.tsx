...
function CustomTooltip({
  ...
  return (
    <div {...tooltipProps} className="bg-base-200 text-base-content rounded-lg shadow-xl p-5 max-w-md border-2 border-base-300">
      {step.title && (
  ...
  const steps: Step[] = [
    {
      ...
      content: (
        <div>
          ...
          <p>Let's take a quick tour to help you get started tracking and analyzing your AI coding sessions.</p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>GuideAI can track sessions from multiple AI coding assistants like Claude Code, GitHub Copilot, and more.</p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>Set the directory where Claude Code stores your session data. This is typically <code className="bg-base-300 px-1 rounded">~/.claude</code>.</p>
          <p className="mt-2 text-sm text-info">Tip: Press Cmd+Shift+. in the folder picker to show hidden folders.</p>
        </div>
      ),
      placement: 'bottom',
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div>
          ...
          <p>Toggle this on to start tracking Claude Code sessions. GuideAI will automatically watch for new sessions.</p>
        </div>
      ),
      placement: 'left',
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div>
          ...
          <p>Once enabled, the file watcher monitors your session files in real-time. You can pause and resume watching at any time.</p>
        </div>
      ),
      placement: 'top',
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mt-2 text-sm text-base-content/70">Logs help troubleshoot any issues with file watching or uploads.</p>
        </div>
      ),
      placement: 'bottom',
      disableBeacon: true,
    ...
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-lg font-bold mb-2">Sessions</h3>
          <p>View all tracked sessions here. You can filter, search, analyze metrics, and view full transcripts of your AI conversations.</p>
        </div>
      ),
      placement: 'center',
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div>
          ...
          <p>Click Next to view the upload queue where you can monitor pending and failed session uploads.</p>
        </div>
      ),
      placement: 'right',
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-lg font-bold mb-2">Upload Queue</h3>
          <p>Here you can see pending, processing, and failed uploads. You can retry failed uploads or clear them from the queue.</p>
        </div>
      ),
      placement: 'center',
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div>
          ...
          <p>The Settings page is where you can manage all your application settings and access logs for the entire application and all providers.</p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>Add your Claude or Gemini API key here to enable local AI-powered session summaries and quality scores.</p>
          <p className="mt-2 text-sm text-base-content/70">Keys are stored locally and used only on your machine—never sent to GuideAI servers.</p>
        </div>
      ),
      placement: 'top',
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div>
          ...
          <p>To sync your sessions to the GuideAI cloud, sign in with GitHub, Google, GitLab, or email.</p>
          <p className="mt-2">Once logged in, you can choose sync options on each provider page:</p>
          <ul className="list-disc list-inside space-y-1 mt-2 text-sm">
            <li><strong>Nothing:</strong> Local only</li>
            <li><strong>Metrics Only:</strong> Privacy mode</li>
            <li><strong>Transcript & Metrics:</strong> Full sync</li>
          </ul>
        </div>
      ),
      placement: 'bottom',
      ...
      content: (
        <div>
          ...
          <p className="mt-3 text-sm text-base-content/70">
            You can restart this tour anytime from the Settings page or by clicking the help button in the header.
          </p>
        </div>
      ),
      placement: 'center',
